/**
 * ============================================================
 * investments.js - ملف التحكم المركزي للاستثمارات (الإصدار النهائي)
 * ============================================================
 * تم إصلاح شروط التحقق لتضمن ظهور البيانات والمؤشرات 
 * في كل مرة يتم فيها فتح الصفحة أو التنقل عبر الـ SPA.
 * ============================================================
 */
...
(function() {
    ...
    // ============================================================
    // 2. حماية الـ ID عبر التخزين المؤقت للـ SPA
    // ============================================================
    ...
    // ============================================================
    // 3. تهيئة صفحة السوق والمؤشرات (opportunities.html)
    // ============================================================
    function initOpportunities() {
        let gridCont = document.getElementById('gridContainer');
        if (!gridCont) return; // تم إزالة شرط المنع العدواني لضمان التحديث
                ...
                if(typeof Chart !== 'undefined') {
                    ...
                    if(ctxStatus) {
                        ...
                        window.statusChartInstance = new Chart(ctxStatus, {
                            type: 'doughnut',
                            data: {
                                labels: ['النشطة/قائم', 'القادمة', 'المنتهية', 'المغلقة', 'الملغاة', 'المكتملة'],
                                datasets: [{
                                    data: [counts.active, counts.upcoming, counts.finished, counts.closed, counts.cancelled, counts.completed],
                                    backgroundColor: ['#028090', '#10b981', '#cbd5e1', '#334155', '#ef4444', '#6366f1'],
                                    borderWidth: 0
                                }]
                            },
                            options: { 
                                ...
                                plugins: { 
                                    legend: { position: 'right', rtl: true, labels: { font: { family: 'Tajawal', size: 12 } } },
                                    datalabels: { color: '#fff', font: { weight: 'bold', size: 16 }, formatter: (v) => v > 0 ? v : '' } 
                                } 
                            }
                        });
                    }
                    ...
                    if(ctxOpp) {
                        ...
                        window.oppChartInstance = new Chart(ctxOpp, {
                            ...
                            options: { 
                                ...
                                scales: { y: { position: 'right', grid: { display: false } }, y1: { position: 'left' } }
                            }
                        });
                    }
                }
        ...
        const typeF = document.getElementById('typeFilter'), statusF = document.getElementById('statusFilter'), searchI = document.getElementById('searchInput');
    ...
    // ============================================================
    // 5. تهيئة صفحة الانضمام الشاملة (cancelled-investments.html)
    // ============================================================
