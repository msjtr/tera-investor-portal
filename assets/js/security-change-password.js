...
(function() {
    ...
    async function initPage() {
        ...
        // نستخدم الدالة العامة من security.js (إن وجدت) أو نعرفها محلياً
        const toggleFn = window.togglePasswordVisibility || function(e) {
            e.preventDefault();
            e.stopPropagation();
        ...
        document.querySelectorAll('.password-toggle').forEach(function(btn) {
            btn.removeEventListener('click', toggleFn);
