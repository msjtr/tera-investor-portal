 ...
 * النسخة المُحدَّثة: حماية من إعادة تعريف الصفحات، دمج محسّن
 * ============================================================
 */
...
if (!window.SecurityPages['change-password']) {
    // يتم التعريف فقط إذا لم يكن معرّفاً مسبقاً (مثلاً من security-change-password.js)
    ...
    console.log('ℹ️ [Security] تم الاحتفاظ بتعريف change-password من ملف منفصل.');
}
