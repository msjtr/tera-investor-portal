...
(function() {
    ...
    function ensureListElement() {
        ...
        if (container) {
            ...
            console.log('✅ Created notificationsList in found container');
            return true;
        }
        ...
        console.log('✅ Created notificationsList in body');
        return true;
    }

    // ─── عرض الإشعارات ───
    function render(notifications, page = 1) {
        if (!ensureListElement()) return;
    ...
    function init() {
        ...
        if (!ensureListElement()) {
            if (++initRetries < MAX_INIT_RETRIES) {
                ...
                console.error('❌ تعذر إنشاء عنصر قائمة الإشعارات بعد عدة محاولات.');
            }
            return;
        }
